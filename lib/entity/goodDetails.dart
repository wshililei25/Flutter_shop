class GoodsDetailsEntity {
  ...
  GoodsDetailsEntity({this.code, this.message, this.data});

  GoodsDetailsEntity.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new GoodsDetails.fromJson(json['data']) : null;
  }
...
class GoodsDetails {
  ...
  GoodsDetails({this.goodInfo, this.goodComments, this.advertesPicture});
